...
class Course(models.Model):
    ...
    course_director = models.CharField(_("course director"), max_length=120)
    level = models.CharField(_("level"), max_length=120, choices=LevelChoices.choices)
...
class LessonMaterial(models.Model):
    ...
    material_type = models.CharField(
        _("Material Type"), max_length=120, choices=MaterialType.choices
    )
    title = models.CharField(_("title"), max_length=120)
